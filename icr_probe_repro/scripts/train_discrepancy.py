...
from spanlab.features import extract_discrepancy_features
from spanlab.paths import RESULTS_DIR
from spanlab.training import run_sklearn_family


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train discrepancy-feature span-level models.")
...
def main() -> None:
    ...
    output_dir = args.output_dir or (RESULTS_DIR / args.dataset_path.stem / "discrepancy")
    run_sklearn_family(
        ...
        feature_builder=extract_discrepancy_features,
